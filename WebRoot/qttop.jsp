...
-->                    </span>
    ...
    if((String)request.getSession().getAttribute("username")==null || (String)request.getSession().getAttribute("username")==""){
     %>
					   					 <button class="btn btn-primary" data-toggle="modal" data-target="#myLoginModal">登录</button> <a href="zhuceyonghuadd.jsp" class="btn btn-danger">注册</a>
										   <%}else{ %>
...
<!--		 <li><a href='zhuceyonghuadd.jsp'>注册用户注册</a></li>
--><li><a href='xcxxListtp.do'>相册信息</a></li>
<li><a href='spxxListtp.do'>视频信息</a></li>

		 <li class='show'><a >新闻信息</a>
	<div class='pa'><a href='xwtzList.do?lb=站内新闻'>站内新闻</a> <a href='xwtzList.do?lb=公告通知'>公告通知</a> </div>
