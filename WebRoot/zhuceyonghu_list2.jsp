...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">注册用户列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="zhuceyonghuList2.do" name="myform" method="post">
    ...
    <td align='center'>${u.issh} </td>
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateZhuceyonghu.do?id=${u.id }">个性设置</a> <a class="btn btn-info btn-small" href="zhuceyonghuDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="zhuceyonghuList2.do?page=1" >首页</a>
             <a href="zhuceyonghuList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zhuceyonghuList2.do?page=${page.page+1 }">下一页</a>
			<a href="zhuceyonghuList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
