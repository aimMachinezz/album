...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addXiangcexinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">添加相册信息</td>
						</tr>
...
<script language=javascript >  
 ...
 function checkform(){  
	...
	var xiangcebiaotiobj = document.getElementById("xiangcebiaoti"); if(xiangcebiaotiobj.value==""){document.getElementById("clabelxiangcebiaoti").innerHTML="&nbsp;&nbsp;<font color=red>请输入相册标题</font>";return false;}else{document.getElementById("clabelxiangcebiaoti").innerHTML="  "; } 	var tupianshuliangobj = document.getElementById("tupianshuliang"); if(tupianshuliangobj.value!=""){ if(/^[0-9]+.?[0-9]*$/.test(tupianshuliangobj.value)){document.getElementById("clabeltupianshuliang").innerHTML=""; }else{document.getElementById("clabeltupianshuliang").innerHTML="&nbsp;&nbsp;<font color=red>必需数字型</font>"; return false;}}      
