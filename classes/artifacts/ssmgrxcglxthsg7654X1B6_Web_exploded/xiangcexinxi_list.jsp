...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">相册信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xiangcexinxiList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bianhao}</td>    <td>${u.xiangcebiaoti}</td>    <td>${u.xiangceleixing}</td>    <td width='90' align='center' bgcolor='#ebf0f7'><a href='${u.xiangcefengmian}' target='_blank'><img src='${u.xiangcefengmian}' width=88 height=99 border=0 /></a></td>    <td width='90' align='center' bgcolor='#ebf0f7'><a class="btn btn-info btn-small" href='${u.wenjian}' target='_blank'>下载</a></td>    <td>${u.tupianshuliang}</td>        <td>${u.gexingqianming}</td>    <td>${u.faburiqi}</td>    <td>${u.faburen}</td>    <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=xiangcexinxi'"/></td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateXiangcexinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteXiangcexinxi.do?id=${u.id }"
		 ...
		 <c:if test="${page.page>1}">
              <a href="xiangcexinxiList.do?page=1" >首页</a>
             <a href="xiangcexinxiList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xiangcexinxiList.do?page=${page.page+1 }">下一页</a>
			<a href="xiangcexinxiList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
