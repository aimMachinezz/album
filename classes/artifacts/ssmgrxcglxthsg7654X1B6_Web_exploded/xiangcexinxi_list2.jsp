...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">相册信息列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xiangcexinxiList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.bianhao}</td>    <td>${u.xiangcebiaoti}</td>    <td>${u.xiangceleixing}</td>    <td width='90' align='center' bgcolor='#ebf0f7'><a href='${u.xiangcefengmian}' target='_blank'><img src='${u.xiangcefengmian}' width=88 height=99 border=0 /></a></td>    <td width='90' align='center' bgcolor='#ebf0f7'><a class="btn btn-info btn-small" href='${u.wenjian}' target='_blank'>下载</a></td>    <td>${u.tupianshuliang}</td>        <td>${u.gexingqianming}</td>    <td>${u.faburiqi}</td>    <td>${u.faburen}</td>    <td align='center'>${u.issh} </td>
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateXiangcexinxi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteXiangcexinxi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="xcxxDetail.do?id=${u.id }" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="xiangcexinxiList2.do?page=1" >首页</a>
             <a href="xiangcexinxiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xiangcexinxiList2.do?page=${page.page+1 }">下一页</a>
			<a href="xiangcexinxiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
