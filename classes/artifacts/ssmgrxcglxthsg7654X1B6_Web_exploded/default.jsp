...
<jsp:include page="bht.jsp"></jsp:include>
  ...
  <section id='introduce'>
        <div class='container'>
			<div class='head text-center'><h3>相册展示</h3></div>
            <div class='row'>
			 <c:forEach items="${syxiangcexinxi}" var="b">
                <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 works'><a href="xcxxDetail.do?id=${b.id}"><div class='bg'>${b.xiangcebiaoti}</div><div class='tab-content item' data-brief=''><img src="${b.xiangcefengmian}" alt=''></div></a></div>
			</c:forEach>
            </div>
        </div>
    </section>
   <section id='introduce'>
        <div class='container'>
			<div class='head text-center'><h3>视频查看</h3></div>
            <div class='row'>
			<c:forEach items="${syshipinxinxi}" var="a">
                <div class='col-xs-12 col-sm-6 col-md-4 col-lg-3 works'><a href="spxxDetail.do?id=${a.id}"><div class='bg'>${a.shipinbiaoti}</div><div class='tab-content item' data-brief=''><img src="${a.tupian}" alt=''></div></a></div>
			 </c:forEach>
            </div>
        </div>
    </section>
