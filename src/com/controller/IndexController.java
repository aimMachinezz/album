...
public class IndexController {
    ...
    @Resource
    private ShipinxinxiServer shipinxinxiServer;
    @Resource
    private XiangcexinxiServer xiangcexinxiServer;
    ...
    public String showIndex(ModelMap map) {
        ...
        List<Shipinxinxi> syshipinxinxi = shipinxinxiServer.getsyshipinxinxi1(null);
        List<Xiangcexinxi> syxiangcexinxi = xiangcexinxiServer.getsyxiangcexinxi1(null);
        ...
        map.put("syshipinxinxi", syshipinxinxi);
        map.put("syxiangcexinxi", syxiangcexinxi);
